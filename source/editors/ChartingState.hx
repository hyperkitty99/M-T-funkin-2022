...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['that fucking flower that i hate', "Value 1: 1 ON, leave blank to turn off"],
		...
		['Blackout', "Value 1: 1 ON, leave blank to turn off"],
		['Flashing Camera', "Value1 = The amount of time you want the flash to last for. If you leave value2 empty the flash will last for 0.5 seconds"],
		['Flashing Camera2', "same thing as flashing camera 1 but not forced"],
		['Cinema bars S', "Value 1 : SPEED. Value 2 : DISTANCE."],
		['Set barrel in', "Zoom\nValue 1: Zoom\nValue 2: Duration"],
		['Set barrel out', "Zoom\nValue 1: Zoom\nValue 2: Duration"],
		...
		['Mid-Song-Countdown', "Value 1: What Countdown number should pop up"]
	];
